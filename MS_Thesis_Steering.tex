...
\begin{abstract}
    ...
    The physical system consist of two optical waveguides which are coupled evanescently, the coherent energy exchange between the modes is described by the Hamiltonian while the dissipation and attenuation mechanisms are modeled by a Lindblad master equation that allows the system to be analysed as an open quantum system. Within the Gaussian-state formalism, the first and the second moments of field quadratures give the full description of all the physical properties of the system. Quantum entanglement is quantified using logarithmic negativity ($E_N$), while quantum steering is quantified using the Gaussian steering measure ($S$).
