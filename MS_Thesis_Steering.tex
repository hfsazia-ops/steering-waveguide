...
I am grateful to the Department of Physics, Qauid-e-Azam University, for providing a supportive research environment throughout this work.
...
\hyperref[fig:3.1]{\color{blue}3.1 \quad Schematic diagram of a coupled waveguide system} \dotfill 24

\hyperref[fig:4.1]{\color{blue}4.1 \quad Time Evolution of Gaussian Quantum Steering and Entanglement} \dotfill 34

\hyperref[fig:4.2]{\color{blue}4.2 \quad Effect of Nonclassicality $\tau$} \dotfill 36

\hyperref[fig:4.3]{\color{blue}4.3 \quad Effect of Purity $\mu$} \dotfill 38

\hyperref[fig:4.4]{\color{blue}4.4 \quad Effect of Loss Parameter $\kappa$} \dotfill 40

\hyperref[fig:4.5]{\color{blue}4.5 \quad Gaussian Quantum Steering and Entanglement in Squeezed States} \dotfill 43

\hyperref[fig:4.6]{\color{blue}4.6 \quad Effect of Coupling Strength on Quantum Steering and Entanglement} \dotfill 45
